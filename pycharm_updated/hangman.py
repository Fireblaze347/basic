...
# capitalised words dont work, repeated works get a bit broken
word_list = ["abruptly", "absurd", "abyss", "affix", "askew", "avenue", "awkward", "axiom", "azure", "bagpipes",
             ...
             "zombie"]  # list of words that can be asked
selected_word = "snow leopard"  # the selected word (chosen randomly)
